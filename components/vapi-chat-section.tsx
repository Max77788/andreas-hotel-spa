      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          ...
          <a
            ...
            className="inline-block border border-[var(--hotel-gold)] text-[var(--hotel-gold)] font-body text-xs tracking-[0.3em] uppercase px-6 py-3 hover:bg-[var(--hotel-gold)] hover:text-[var(--hotel-charcoal)] transition-all duration-300 self-start md:self-auto"
          >
            Book Directly
          </a>
        </div>
